    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Select value={statusFilter} onValueChange={(v) => v !== null && setStatusFilter(v)}>
          ...
          <SelectContent>
            ...
            <SelectItem value="SUCCEEDED" label="Succeeded">Succeeded</SelectItem>
            <SelectItem value="PROCESSING" label="Processing">Processing</SelectItem>
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {generations.map((gen) => (
            <Card key={gen.id} className="group hover:border-primary/30 transition-colors">
              <CardContent className="flex items-center gap-4 p-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                    {gen.theme?.name && (
                      <span className="text-xs text-muted-foreground">{gen.theme.name}</span>
                    )}
                ...
                <Badge variant="outline" className={`shrink-0 ${statusColor[gen.status] || ""}`}>
